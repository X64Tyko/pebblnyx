...
void test_save(void)
{
	...
	pnx_host_reset();
	{
		...
		// The struct's tail padding is included on purpose: pnx_save's contract is an exact
		// byte round-trip, not field-by-field equality, and a full-struct memcmp is the only
