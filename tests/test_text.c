...
void test_text(void) {
  ...
  for (uint32_t i = 0; i < 8; i++) resources[i] = i + 500;
  ...
  pnx_host_reset();
  T_CHECK_EQ(pnx_text_draw(t, &font, "!\" !", 0, 20, INK),
             pnx_text_width(&font, "!\" !"));
  ...
  // 0b00_01_10_11.
  {
    ...
    e[0] = 0; e[1] = 0;      // offset 0
    e[2] = 4; e[3] = 1;      // 4x1
    e[4] = 5;                // advance
    e[5] = 0; e[6] = 1;      // bearings
